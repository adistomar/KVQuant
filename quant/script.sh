...
# CUDA_VISIBLE_DEVICES=0 python llama_simquant.py \
#     $hf_path/$model_id \
#     --abits $bits \
#     --nsamples $nsamples \
#     --seqlen $seqlen \
#     --nuq \
#     --fisher $gradients_path/$model_id \
#     --quantize \
#     --include_sparse \
#     --sparsity-threshold 0.99 \
#     --quantizer-path ${model}/${bits}bit_quantizer.pickle > logs/${model}_${bits}bits.log 2>&1 &

# bits=3

# CUDA_VISIBLE_DEVICES=1 python llama_simquant.py \
#     $hf_path/$model_id \
#     --abits $bits \
#     --nsamples $nsamples \
#     --seqlen $seqlen \
